...
export type AppError = ApiError | NetworkError | TimeoutError | AuthError | ForbiddenError;
...
export function parseError(error: unknown): AppError {
  ...
  return new ApiError({ message: "An unexpected error occurred", code: "UNKNOWN", status: 0 });
}
